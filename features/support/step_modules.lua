...
local MODULES = {
    ...
    { file = "lib/ComponentCache.lua", module = "ComponentCache", isClass = true },
    { file = "lib/NodeComponent.lua", module = "NodeComponent", isClass = true },
    { file = "src/NodeCache.lua", module = "NodeCache", isClass = true },
